...
class ProductResults extends StatefulWidget {
  @override
  _ProductResultsState createState() => new _ProductResultsState();
}

class _ProductResultsState extends State<ProductResults> {
...
// Find the Scaffold in the Widget tree and use it to show a SnackBar
  ...
  Future<String> _getJson(int offset, int limit) async {
    ...
    final String url = 'http://www.a2zonlineshoppy.com/api/product/getproducts/$type/$key/$offset/$limit';
