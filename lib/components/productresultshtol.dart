...
class ProductResultsHtoL extends StatefulWidget {
  @override
  _ProductResultsHtoLState createState() => new _ProductResultsHtoLState();
}

class _ProductResultsHtoLState extends State<ProductResultsHtoL> {
...
// Find the Scaffold in the Widget tree and use it to show a SnackBar
  ...
  Future<String> _getJson(int offset, int limit) async {
    ...
    final String url = 'http://www.a2zonlineshoppy.com/api/product/getproductshtol/$type/$key/$offset/$limit';
