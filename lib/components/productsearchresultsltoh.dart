...
class ProductSearchResultsLtoH extends StatefulWidget {
  @override
  _ProductSearchResultsLtoHState createState() => new _ProductSearchResultsLtoHState();
}

class _ProductSearchResultsLtoHState extends State<ProductSearchResultsLtoH> {
...
// Find the Scaffold in the Widget tree and use it to show a SnackBar
  ...
  Future<String> _getJson(int offset, int limit) async {
    ...
    final String urladd = 'https://www.a2zonlineshoppy.com/api/product/searchproductsltoh/$offset/$limit';
