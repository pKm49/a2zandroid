...
class ProductSearchResultsHtoL extends StatefulWidget {
  @override
  _ProductSearchResultsHtoLState createState() => new _ProductSearchResultsHtoLState();
}

class _ProductSearchResultsHtoLState extends State<ProductSearchResultsHtoL> {
...
// Find the Scaffold in the Widget tree and use it to show a SnackBar
  ...
  Future<String> _getJson(int offset, int limit) async {
    ...
    final String urladd = 'https://www.a2zonlineshoppy.com/api/product/searchproductshtol/$offset/$limit';
