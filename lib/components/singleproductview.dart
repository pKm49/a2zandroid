...
class _SingleProductViewState extends State<SingleProductView> {
  ...
  Future<String> getJsonData() async{
    ...
    final String url = 'https://www.a2zonlineshoppy.com/api/product/getproduct/$productId/';
      ...
      child: Container(
        height: MediaQuery.of(context).size.height *1.0,//
          child: Single_product(
              title:data[0]['title'],
              id:data[0]['_id'],
              picture1:'https://www.a2zonlineshoppy.com/public2/products/'+data[0]['_id']+'imageone.jpg',
              picture2:'https://www.a2zonlineshoppy.com/public2/products/'+data[0]['_id']+'imagetwo.jpg',
              picture3:'https://www.a2zonlineshoppy.com/public2/products/'+data[0]['_id']+'imagethree.jpg',
              ...
              newprice:data[0]['a2zMoney'] == null? (data[0]['oldPrice']-((data[0]['oldPrice'] * data[0]['a2zPrice'])/100).round()):data[0]['a2zMoney'],
...
class Single_product extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child:
      new Padding(padding: const EdgeInsets.only(top:8.0,bottom:8.0),child:
      ListView(
        children: <Widget>[
          ...
          Container(
            ...
            child: InkWell(
              onTap: () async{
                ...
                sharedPreferences.setString('imagethree','$picture3');
              ...
              child: new Carousel(
                ...
                images: [
                  NetworkImage('$picture1'),
                  NetworkImage('$picture2'),
                  NetworkImage('$picture3'),
                ],
          ...
          Text('$title',style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.center,textScaleFactor: 1.3,),),
          ...
          new Padding(padding: const EdgeInsets.all(2.0),child:
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text('₹$newprice  ',style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.center,textScaleFactor: 1.2,),
              Text('₹$oldprice',style: TextStyle(fontWeight: FontWeight.normal,decoration: TextDecoration.lineThrough,color: Colors.blueGrey, ),textAlign: TextAlign.center,textScaleFactor: 1.2,),
              Text('  $offerpercent %off',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.green),textAlign: TextAlign.center,textScaleFactor: 1.2,),
            ],
          )
          ),

          new Padding(padding: const EdgeInsets.only(top:12.0,right: 6.0,left:6.0),child:
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Expanded(child:
              ButtonTheme(
                ...
                child: RaisedButton(
                      ...
                      showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: size.length == 0?Text("Size: Default",textScaleFactor: 1.2,style: TextStyle(fontWeight: FontWeight.bold)):
                              Size(
                                siz: size,
                                len: size.length,
                              )
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(child: Text('Size',textAlign: TextAlign.center,textScaleFactor: 1.2,)),
              ...
              ButtonTheme(
                ...
                child: RaisedButton(
                      ...
                      showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: color.length == 0?Text("Color: Default",textScaleFactor: 1.2,style: TextStyle(fontWeight: FontWeight.bold)):
                              Color(
                                color: color,
                                leng: color.length,
                              )
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(child: Text('Color',textAlign: TextAlign.center,textScaleFactor: 1.2,)),
                        Expanded(child: Icon(Icons.arrow_drop_down),)
                      ],
                    )
                ),
                ...
                child: RaisedButton(
                    ...
                    onPressed: (){
                      showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                                title: Text('Quantity',textAlign: TextAlign.center),
                                  ...
                                  child: ListView(
                                    ...
                                    children: <Widget>[
                                      ...
                                      ListTile(
                                        onTap: () async{
                                          SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
                                          sharedPreferences.setString('quantity','1');
                                          Navigator.pop(context);
                                        },
                                        title: Text('1',style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.center),
                                      ),
                                      ListTile(
                                        onTap: ()async{
                                          SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
                                          sharedPreferences.setString('quantity','2');
                                          Navigator.pop(context);
                                        },
                                        title: Text('2',style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.center),
                                      ),
                                      ListTile(
                                        onTap: ()async{
                                          SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
                                          sharedPreferences.setString('quantity','3');
                                          Navigator.pop(context);
                                        },
                                        title: Text('3',style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.center),
                                      ),
                                    ],
                                  ),
                                )
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(child: Text('Qty',textAlign: TextAlign.center,textScaleFactor: 1.2,)),
                        Expanded(child: Icon(Icons.arrow_drop_down),)
                      ],
                    )
                ),
          ...
          Text('$cod',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.green),maxLines: 1,textScaleFactor: 1.2,textAlign: TextAlign.center),),

          new Padding(padding: const EdgeInsets.only(top:12.0),child:
          Text('Description',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.grey.shade800),textAlign: TextAlign.center,textScaleFactor: 1.2,)),

          new Padding(padding: const EdgeInsets.only(top:12.0,right: 6.0,left:6.0),child:
          Text('$details',style: TextStyle(color: Colors.grey.shade800),textAlign: TextAlign.justify,textScaleFactor: 1.1,)),

          new Padding(padding: const EdgeInsets.only(top:12.0),child:
          Text('Related Products',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.grey.shade800),textAlign: TextAlign.center,textScaleFactor: 1.2,)),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                return Single_products(
                  ...
                  picture:'https://www.a2zonlineshoppy.com/public2/products/'+lispdts[index]['_id']+'imageone.jpg',
                  rating:lispdts[index]['rating'],
                  id:lispdts[index]['_id'],
                  assuredpicture:'images/cats/assured.png',
                  oldprice:lispdts[index]['oldPrice'],
                  offerpercent:lispdts[index]['a2zPrice'],
                  cod:lispdts[index]['cod']== true ? 'cash on delivery': '',
                  newprice:lispdts[index]['a2zMoney'] == null? (lispdts[index]['oldPrice']-((lispdts[index]['oldPrice'] * lispdts[index]['a2zPrice'])/100).round()):lispdts[index]['a2zMoney'],
                );
              },
            ),
          )),
        ...
        child: Container(
            ...
            child:Column(
              ...
              children: <Widget>[
                ...
                Text('$titl',style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.center),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    new Container(
        ...
        itemBuilder: (BuildContext context, int index) {
          if(widget.leng == 1){
            if(widget.color[index] == ""){
              ...
              title=widget.color[index].length<=17 ? widget.color[index] : widget.color[index].substring(0, 12);
            }
            colorchanged=title;
