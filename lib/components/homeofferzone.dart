...
class HomeOfferZone extends StatefulWidget {
  @override
  _HomeOfferZoneState createState() => _HomeOfferZoneState();
}

class _HomeOfferZoneState extends State<HomeOfferZone> {

  final String url = 'https://www.a2zonlineshoppy.com/api/homepageofferzone';
  List data;
  SharedPreferences sharedPreferences ;
  Map<String, String> heaaders = {};
  String homeofferzone;
  ...
  Future<String> getJsonData() async{
    ...
    homeofferzone = sharedPreferences.getString('homeofferzone');

    if(homeofferzone == null){
      if(tock!=null){
      ...
      setState(() {
        ...
        data = mobiles["offerzone"];
      });


      homeofferzone = json.encode(data);
      sharedPreferences.setString('homeofferzone', homeofferzone);
      return "success";
    }else{
      setState(() {
        data = json.decode(homeofferzone);
      });
