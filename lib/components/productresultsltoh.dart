...
class ProductResultsLtoH extends StatefulWidget {
  @override
  _ProductResultsLtoHState createState() => new _ProductResultsLtoHState();
}

class _ProductResultsLtoHState extends State<ProductResultsLtoH> {
    ...
    return new Column(
      children: <Widget>[
        Visibility(
          ...
          child: Padding(padding: const EdgeInsets.all(6.0),child:
...
// Find the Scaffold in the Widget tree and use it to show a SnackBar
  ...
  Future<String> _getJson(int offset, int limit) async {
    ...
    final String url = 'http://www.a2zonlineshoppy.com/api/product/getproductsltoh/$type/$key/$offset/$limit';
  ...
  Future<int> _getTotal() async {
    ...
    String cook = sharedPreferences.getString('Cookie');
    String tock = sharedPreferences.getString('tocken');
    urlcount = 'http://www.a2zonlineshoppy.com/api/product/getproductcount/$type/$key';
...
class Single_product extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    String titl =  title.length<=17 ? title : title.substring(0, 15)+'...';
    ...
    return Padding(padding: const EdgeInsets.all(6.0),
      child: InkWell(
        ...
        child: Container(
            ...
            margin: const EdgeInsets.only(top:5.0,bottom:6.0,left:4.0,right: 4.0),
            ...
            child:Column(
              ...
              children: <Widget>[
                ...
                Text('$titl',style: TextStyle(fontWeight: FontWeight.bold),maxLines: 1,textAlign: TextAlign.center),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    new Container(
